...
public class Weather_Controller {
    ...
    private final String[] townArr1 = { "전체", "한림음", "애월읍", "구좌읍", "조천읍", "한경명", "추자면", "우도면", "일도1동", "일도2동", "이도1동", "이도2동",
            "삼도1동", "삼도2동", "용담1동", "용담2동", "건입동", "화북동", "삼양동", "봉개동", "아라동", "오라동", "연동", "노형동", "외도동", "이호동",
            "도두동" };

    private final String[] townArr2 = { "전체", "대정읍,마라도", "남원읍", "성산읍", "안덕면", "표선면", "송산동", "정방동", "중앙동", "천지동", "효돈동", "영천동",
            "동홍동", "서홍동", "대륜동", "대천동", "중문동", "예래동" };

    private final int[] areaCode = { 50110000, 50110250, 50110253, 50110256, 50110259, 50110310, 50110320, 50110330, 50110510,
            50110520, 50110530, 50110540, 50110550, 50110560, 50110570, 50110580, 50110590, 50110600, 50110610,
            50110620, 50110630, 50110640, 50110650, 50110660, 50110670, 50110680, 50110690, 50130250, 50130253,
            50130259, 50130310, 50130320, 50130510, 50130520, 50130530, 50130540, 50130550, 50130560, 50130570,
            50130580, 50130590, 50130600, 50130610, 50130620 };
    ...
    public Weather[] getWeatherlists()
    {
		...
		protocol.setPacket(Protocol.PT_REQUEST, Protocol.PT_WEATHER, Protocol.PT_REQUEST, Protocol.PT_USER, weather.toBytes());
