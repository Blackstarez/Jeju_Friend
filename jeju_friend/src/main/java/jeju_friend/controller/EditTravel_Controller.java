...
public class EditTravel_Controller {
    ...
    public void enter(String id, TourPlan tour)
    {
        ...
        setSelectedRegion(tour.getAreaInterest());
    ...
    public void editTravel(TourPlan tourPlan) throws IOException, InterruptedException, ExecutionException {
        ...
        protocol.setPacket(Protocol.PT_REQUEST, Protocol.PT_TOURPLAN, Protocol.PT_MODIFY, Protocol.PT_USER, tourPlan.toBytes());
    ...
    public void setSelectedRegion(int region) {
        ...
        switch(region)
        {
            case 1:regionBtn1.setSelected(true);
            break;
            case 2:regionBtn1.setSelected(true);
            break;
            case 3:regionBtn1.setSelected(true);
            break;
            case 4:regionBtn1.setSelected(true);
            break;
            case 5:regionBtn1.setSelected(true);
            break;
        }
		
    }

    private void setSelectedPartner(int tourWith) {
        switch(tourWith)
        {
            case 1:
                familyBtn_Actioned();
